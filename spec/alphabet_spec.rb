...
RSpec.describe Alphabet do
  ...
  describe '#split_message' do
    it 'can split message over 80 characters to multiple lines' do
      ...
      formatted_message = ".00.00...00.0.0.0.00...0..000.0.00000...0.0....0.0...00.0...0.000....00.0....00.\n" +
      ...
      expect(@alphabet.split_message(raw_message)).to eq(formatted_message)
    end
  end
